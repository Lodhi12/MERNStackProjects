  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
          ...
          >
            ...
            <div className="p-4">
              ...
              >
                <p
                  className={`w-2 h-2 ${
                    item.available ? "bg-green-50" : "bg-gray-500"
                  } rounded-full`}
                ></p>
                <p>{item.available ? "Available" : "Not Available"}</p>
              </div>
              <p className="text-grapy-900 text-lg font-medium">{item.name}</p>
      ...
      <button
        ...
        className="bg-blue-50 text-gray-600 pxx-12 py-3 rounded-full mt-10"
      >
        more
      </button>
    </div>
