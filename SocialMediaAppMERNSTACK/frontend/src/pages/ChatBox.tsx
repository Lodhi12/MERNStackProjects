  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div className="flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-linear-to-r from-indigo-50 to-purple-50 border-p border-gray-300">
          <img
                  ...
                  >
                    {message.message_type === "image" && (
                      <img
                        ...
                        className="w-full max-w-sm rounded-e-lg mb-1"
                        alt=""
                      />
                    )}
                    <p>{message.text}</p>
