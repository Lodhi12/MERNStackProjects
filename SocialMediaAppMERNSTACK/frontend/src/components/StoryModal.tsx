...
interface StoryModalPropsType {
  setShowModal: React.Dispatch<SetStateAction<boolean>>;
  fetchStories: () => void;
}

const StoryModal = ({ setShowModal, fetchStories }: StoryModalPropsType) => {
  const bgColors = [
    "#4f46e5",
    "#7c3aed",
    "#db2777",
  ...
  return (
    <div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-4 flex item-center justify-between">
          <button
